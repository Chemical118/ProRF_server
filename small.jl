...
@everywhere function small_dataset(data::Tuple{String, Char, Int, Int, Int})
    ...
    MZ, SZ = iter_get_reg_importance(R, X, Y, L, feat, tree, 500, 1, max_depth=mdep, data_state_seed=data_state, learn_state_seed=learn_state, imp_state=imp_state, val_mode=true)
